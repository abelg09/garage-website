...
const CREW_MEMBERS = [
  ...
  { key: "utsav", name: "Utsav", role: "Art Director", bio: "Weekly wallpaper supplier and heavy biker. Has a magic hat that he uses to keep pulling out references.", zone: { x: 31, y: 6, w: 12, h: 30 }, card: { x: 32.66, y: 25.44, w: 12.84 } },
  { key: "abhay", name: "Abhay", role: "Account Executive", bio: "In-house sports and adventure junkie. Keeps plans A, B, C ready (up to Z if required).", zone: { x: 44, y: 4, w: 13, h: 28 }, card: { x: 44.4, y: 22.89, w: 15.7 } },
  { key: "tanvi", name: "Tanvi", role: "SR. Visualizer", bio: "Dad-humour representative. Outpaces Ai when it comes to incorporating feedback.", zone: { x: 58, y: 7, w: 12, h: 29 }, card: { x: 59.7, y: 26.31, w: 12.26 } },
  { key: "kyle", name: "Kyle", role: "Account Manager", bio: "CMMO - Chief music and magic officer. More resourceful than Doremon.", zone: { x: 70, y: 9, w: 12, h: 29 }, card: { x: 72.24, y: 26.11, w: 9.41 } },
  { key: "aryan", name: "Aryan", role: "Junior Visualizer", bio: "Moves like Jaggu and loves birthdays & farewells (for the cake). The bigger the work-pile, the wider the smile.", zone: { x: 11, y: 38, w: 13, h: 28 }, card: { x: 12.85, y: 47.11, w: 12.64 } },
  { key: "rujvi", name: "Rujvi", role: "SR. Visualizer", bio: "Quietest, until you really know her. Currently overthinking a layout and making ‘just one small change’ for the 47th time.", zone: { x: 26, y: 37, w: 13, h: 28 }, card: { x: 26.9, y: 47.93, w: 15.0 } },
  { key: "vedant", name: "Vedant", role: "Copywriter", bio: "Part-time bartender, full time couch-hogger. Big fan of to-do lists.", zone: { x: 43, y: 34, w: 13, h: 29 }, card: { x: 44.42, y: 48.29, w: 10.72 } },
  { key: "aniket", name: "Aniket", role: "SR. Copywriter", bio: "Loves rewatching movies and talking about movies and well, movies. The hindi dictionary of the office.", zone: { x: 59, y: 37, w: 13, h: 27 }, card: { x: 61.75, y: 48.6, w: 14.88 } },
  { key: "saniya", name: "Saniya", role: "Visualizer", bio: "Resident party-planner and tea-giver. Works just as well in a team as she does solo.", zone: { x: 75, y: 37, w: 13, h: 28 }, card: { x: 77.13, y: 47.42, w: 12.81 } },
  { key: "mobaiyana", name: "Mobaiyana", role: "Copywriter", bio: "Usual over-thinker, occasional song hummer, and often caught daydreaming (she’s just crafting a headline).", zone: { x: 13, y: 66, w: 14, h: 30 }, card: { x: 15.99, y: 75.87, w: 11.71 } },
  { key: "madhurenu", name: "Madhurenu", role: "Creative Director", bio: "Turns thoughts into words and words into trouble. The good kind. Talks cars all the time. Lives in the Garage.", zone: { x: 28, y: 64, w: 14, h: 32 }, card: { x: 28.96, y: 79.49, w: 11.56 } },
  { key: "samir", name: "Samir", role: "SR. Account Manager", bio: "Has more shoes than some people have clothes. Loves a good brainstorming sesh.", zone: { x: 43, y: 62, w: 14, h: 34 }, card: { x: 43.64, y: 74.98, w: 15.07 } },
  { key: "pranali", name: "Pranali", role: "SR. Account Manager", bio: "Certified yapper and kadak chai lover. Powered by enthusiasm, especially if it’s Shawn Mendes-related.", zone: { x: 58, y: 65, w: 13, h: 31 }, card: { x: 60.77, y: 78.67, w: 11.68 } },
  { key: "adwait", name: "Adwait", role: "Art Director", bio: "90% screen-time = football, remaining 10% = soccer. Has a filing system for his filing system.", zone: { x: 72, y: 63, w: 14, h: 33 }, card: { x: 73.51, y: 74.8, w: 12.63 } },
];
